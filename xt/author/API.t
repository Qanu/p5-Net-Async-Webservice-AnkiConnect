...
my $GET_API_FROM_PM=q{grep '^api' lib/Renard/API/AnkiConnect/REST.pm | sed 's/ =>.*$//'};
my $GET_API_FROM_POD=q{grep '=head2' lib/Renard/API/AnkiConnect/REST.pod  | sed 's/=head2/api/g; s/C<//; s/>//;'};
